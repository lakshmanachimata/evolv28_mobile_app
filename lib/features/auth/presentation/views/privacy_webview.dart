...
class _PrivacyWebViewState extends State<PrivacyWebView> {
  ...
  void _retryWithDetailedLogging() {
    print('=== RETRYING PRIVACY LOAD WITH DETAILED LOGGING ===');
    ...
    _controller?.loadRequest(Uri.parse('https://evolv28.com/privacy-policy')).catchError((error) {
      print('=== DETAILED PRIVACY RETRY LOAD REQUEST ERROR ===');
      print('Error: $error');
  ...
  void _openInExternalBrowser() async {
    final Uri url = Uri.parse('https://evolv28.com/privacy-policy');
  ...
  void _initializeWebView() {
    print('=== INITIALIZING PRIVACY WEBVIEW ===');
    print('Timestamp: ${DateTime.now()}');
    print('====================================');
    ...
    try {
        ...
        ..setNavigationDelegate(
          NavigationDelegate(
            onPageStarted: (String url) {
              print('=== PRIVACY PAGE LOADING STARTED ===');
              print('URL: $url');
              print('Timestamp: ${DateTime.now()}');
              print('====================================');
              setState(() {
            ...
            onPageFinished: (String url) {
              print('=== PRIVACY PAGE LOADING FINISHED ===');
              print('URL: $url');
              print('Timestamp: ${DateTime.now()}');
              print('=====================================');
              _timeoutTimer?.cancel();
            ...
            onWebResourceError: (WebResourceError error) {
              _timeoutTimer?.cancel();
              print('=== PRIVACY WEBVIEW RESOURCE ERROR ===');
            ...
            onNavigationRequest: (NavigationRequest request) {
              print('=== PRIVACY NAVIGATION REQUEST ===');
      ...
      print('=== PRIVACY WEBVIEW CONTROLLER CREATED ===');
      print('Controller: $_controller');
      print('==========================================');
      
      // Load the URL
      _controller?.loadRequest(Uri.parse('https://evolv28.com/privacy-policy')).catchError((error) {
        print('=== PRIVACY LOAD REQUEST ERROR ===');
        print('Error: $error');
        print('Error Type: ${error.runtimeType}');
        print('Timestamp: ${DateTime.now()}');
        print('==================================');
      ...
      print('=== PRIVACY WEBVIEW INITIALIZATION ERROR ===');
      print('Error: $e');
      ...
      setState(() {
        _webViewFailed = true;
        _isLoading = false;
        _errorMessage = 'Privacy WebView initialization failed: $e';
      });
    }
  }
                                  ...
                                  children: [
                                    TextButton(
                                      onPressed: () {
                                        setState(() {
                                          _isLoading = false;
                                          _errorMessage = 'Loading cancelled by user.';
                                        });
                                      },
